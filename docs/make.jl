...
DocMeta.setdocmeta!(CrystallographicFFT, :DocTestSetup, :(using CrystallographicFFT); recursive = true)
...
makedocs(;
    modules = [CrystallographicFFT],
    authors = "Yixin Liu <lyx@fudan.edu.cn>",
    repo = "https://github.com/liuyxpp/CrystallographicFFT.jl/blob/{commit}{path}#{line}",
